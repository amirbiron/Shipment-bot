...
stateDiagram-v2
    ...
    SENDER_DELIVERY_LOCATION --> SENDER_DELIVERY_DROPOFF_STREET
...
stateDiagram-v2
    ...
    COURIER_INITIAL --> COURIER_MENU
    COURIER_INITIAL --> COURIER_PENDING_APPROVAL
...
stateDiagram-v2
    ...
    DISPATCHER_ADD_SHIPMENT_DROPOFF_APARTMENT : דירה יעד
    ...
    DISPATCHER_POST_RIDE_CONFIRM : אישור נסיעה
    DISPATCHER_POST_RIDE_DESTINATION : יעד נסיעה
    DISPATCHER_POST_RIDE_ORIGIN : מוצא נסיעה
    DISPATCHER_POST_RIDE_PRICE : מחיר נסיעה
    DISPATCHER_POST_RIDE_SEATS : מספר מקומות
    DISPATCHER_VIEW_ACTIVE_SHIPMENTS : משלוחים פעילים
    DISPATCHER_VIEW_POSTED_RIDES : נסיעות פעילות
    ...
    DISPATCHER_MENU --> DISPATCHER_POST_RIDE_ORIGIN
    DISPATCHER_MENU --> DISPATCHER_VIEW_POSTED_RIDES
    ...
    DISPATCHER_ADD_SHIPMENT_DROPOFF_NUMBER --> DISPATCHER_ADD_SHIPMENT_DROPOFF_APARTMENT
    DISPATCHER_ADD_SHIPMENT_DROPOFF_APARTMENT --> DISPATCHER_ADD_SHIPMENT_DESCRIPTION
    ...
    DISPATCHER_POST_RIDE_ORIGIN --> DISPATCHER_POST_RIDE_DESTINATION
    DISPATCHER_POST_RIDE_ORIGIN --> DISPATCHER_MENU
    DISPATCHER_POST_RIDE_DESTINATION --> DISPATCHER_POST_RIDE_SEATS
    DISPATCHER_POST_RIDE_DESTINATION --> DISPATCHER_MENU
    DISPATCHER_POST_RIDE_SEATS --> DISPATCHER_POST_RIDE_PRICE
    DISPATCHER_POST_RIDE_SEATS --> DISPATCHER_MENU
    DISPATCHER_POST_RIDE_PRICE --> DISPATCHER_POST_RIDE_CONFIRM
    DISPATCHER_POST_RIDE_PRICE --> DISPATCHER_MENU
    DISPATCHER_POST_RIDE_CONFIRM --> DISPATCHER_MENU
    DISPATCHER_VIEW_POSTED_RIDES --> DISPATCHER_MENU
```
