...
stateDiagram-v2
    ...
    STATION_ADD_OWNER_PHONE : STATION.ADD_OWNER.PHONE
    ...
    STATION_CONFIRM_REMOVE_OWNER : STATION.CONFIRM_REMOVE_OWNER
    STATION_GROUP_SETTINGS : הגדרות קבוצות
    STATION_MANAGE_DISPATCHERS : ניהול סדרנים
    STATION_MANAGE_OWNERS : STATION.MANAGE_OWNERS
    ...
    STATION_REMOVE_OWNER_SELECT : STATION.REMOVE_OWNER.SELECT
