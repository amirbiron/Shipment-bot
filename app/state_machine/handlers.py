...
class MessageResponse:
    ...
    def __init__(
        ...
        # טקסט הכפתור הכחול שפותח רשימת בחירה בווטסאפ (WPPConnect list message).
...
"""
    ...
    async def _handle_initial(
        ...
        response = MessageResponse(
            "ברוכים הבאים למערכת iDriver • איי דרייבר! 🚗\n\n"
