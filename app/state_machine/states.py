...
class DispatcherState(str, Enum):
    ...
    ADD_SHIPMENT_DROPOFF_APARTMENT = "DISPATCHER.ADD_SHIPMENT.DROPOFF_APARTMENT"
...
DISPATCHER_TRANSITIONS = {
    ...
    DispatcherState.ADD_SHIPMENT_DROPOFF_NUMBER: [DispatcherState.ADD_SHIPMENT_DROPOFF_APARTMENT],
    DispatcherState.ADD_SHIPMENT_DROPOFF_APARTMENT: [DispatcherState.ADD_SHIPMENT_DESCRIPTION],
